...
<div class="cookie-overlay" id="cookie-overlay">
  <div class="cookie-popup">
    ...
    <p>
      このウェブサイトでは、コンテンツや広告を最適化し、ソーシャルメディア機能を提供し、
      トラフィックを分析するためにクッキーを使用しています。
      「同意する」をクリックすることで、クッキーの使用に同意したものとみなされます。
      詳細については、
      <a href="#" id="cookie-policy-link" class="cta">クッキーポリシー</a>
      をご確認ください。
    </p>

    <a href="#" id="accept-cookies" class="btn-primary">同意する</a>
  </div>
</div>
    ...
    overlay.addEventListener("mousemove", detectMouseMove);
